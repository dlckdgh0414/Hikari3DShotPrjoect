...
[NodeDescription(name: "BossPatternAttack", story: "Attack To [Target] With [PlayEffect] int [StartPos] [StartTargetPos] on [EffectObj]", category: "Action", id: "c548008691f055cab4004a8af2973741")]
public partial class BossPatternAttackAction : Action
{
    ...
    protected override Status OnStart()
    {
        ...
        {
            EffectObj.Value = GameObject.Instantiate(PlayEffect.Value.gameObject,Target.Value.position,Quaternion.identity);
            PlayEffect.Value._entity = _boss.Value;
